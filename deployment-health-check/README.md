...
* https://cdn.openfin.co/tools/deployment/1.0.4/openfin-deployment.js: [@openfin/deployment](https://www.npmjs.com/package/@openfin/deployment) package for checking accessiblity to HERE resources.  CORS needs to be enabled for any endpoint in order for health check to work properly.
